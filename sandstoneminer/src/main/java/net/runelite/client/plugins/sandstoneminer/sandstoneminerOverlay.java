...
@Slf4j
@Singleton
class sandstoneminerOverlay extends OverlayPanel
{
	private final sandstoneminerPlugin plugin;
	private final sandstoneminerConfiguration config;

	String timeFormat;
	private String infoStatus = "Starting...";

	@Inject
	private sandstoneminerOverlay(final Client client, final sandstoneminerPlugin plugin, final sandstoneminerConfiguration config)
	{
		super(plugin);
